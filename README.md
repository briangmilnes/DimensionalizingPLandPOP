...
| 18 | [BestProvenExamples.md](docs/BestProvenExamples.md) | Best verified example per category with In-Product (Yes/No), executable-code (LoEC) and proof (LoP) line estimates |
