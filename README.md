...
| 16 | [CostOfProvingEverything.md](docs/CostOfProvingEverything.md) | Defines "everything" — the full verified stack as one product per line across six tiers — the seed for a cost-of-verification study |
